...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	gScriptVM.registerHostApi("TestDoFile", 0, (HOST_FUNC)TestDoFile);

	std::vector<HostFunction> funcVec;
	funcVec.push_back(HostFunction("Test", 3, TestClass_Test));
	gScriptVM.RegisterUserClass("TestClass", "", funcVec);
